...
class Snitch(EternalClient):
    ...
    def tattle(self, rule, diff, wiki):
        ...
        if 'page' in diff:
            ...
            elif diff['log'] == 'delete-group' or diff['log'] == 'lock' or diff['log'] == 'settings' or diff['log'] == 'rename' or diff['log'] == 'namespaces' or diff['log'] == 'namespaces-delete' or diff['log'] == 'undelete' or diff['log'] == 'unlock':
